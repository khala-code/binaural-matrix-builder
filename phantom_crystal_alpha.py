...
# --- The Physics-Alpha Matrix ---
f_crystal = np.array([132.0, 423.0, 555.0]) # Core Earth-field frequencies
f_target_beat = 12.0                         # Target Alpha flow state (Hz)
offset = f_target_beat / 2.0                 # Symmetrical split (6.0 Hz)
...
# Compile and export
output_filename = "chess_matrix_alpha_12hz.wav"
...
print(f"Synthesized Biological Intercept: {f_target_beat} Hz Alpha Flow")